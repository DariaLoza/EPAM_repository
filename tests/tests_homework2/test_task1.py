...
def test_count_punctuation_chars():
    ...
    assert homeworks.homework2.task1.count_punctuation_chars("data.txt") == 5305


def test_get_rarest_char():
    """Testing that function find rarest symbol for document"""
    assert homeworks.homework2.task1.get_rarest_char("data.txt") == ")"


def test_count_non_ascii_chars():
    """Testing that function count every non ascii char"""
    assert homeworks.homework2.task1.count_non_ascii_chars("data.txt") == 2972


def test_get_most_common_non_ascii_char():
    """Testing that function find most common non ascii char for document"""
    assert homeworks.homework2.task1.get_most_common_non_ascii_char("data.txt") == "ä"
